    ...
    return (
        <>
            <div className="grid gap-x-10 grid-rows-2 grid-flow-col justify-center pt-12 pb-12 items-center">
                ...
                <div className="max-w-fit rounded overflow-hidden shadow-lg bg-white row-span-3 col-span-1 col-end h-full">
                ...
                <div className="max-w-fit rounded overflow-hidden shadow-lg bg-white row-span-1 col-span-2 mb-10">
                ...
                <div className="max-w-fit rounded overflow-hidden shadow-lg bg-white row-span-1 col-span-2 pb-8">
                    <div className="px-6 py-4">
